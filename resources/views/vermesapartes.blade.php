...
@section('titulopagina')
	SGD | Responsable de mesa de partes virtual
@endsection

@section('titulosuperior')
<div class="col-sm-6">
    <h1>
      Registro de mesas de partes virtuales 
      <small></small>
    </h1>
  </div>
  <div class="col-sm-6">
            ...
            <div class="col-sm-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Relacion de usuarios con <small class="bg-warning">ROL DE MESA DE PARTES VITRUAL</small></h3>
                    </div> <!-- /.card-body -->
